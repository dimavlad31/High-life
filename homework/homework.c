...
int main(int argc, char **argv)
{
    ...
    if(nProcesses != 1){    
        ...
        int *localNumsReply = (int *)malloc(rows*columns*sizeof(int));
        for(int l=0;l<numSteps;l++){
            memcpy(localNumsReply,allNums,rows*columns*sizeof(int));
            for(int i=0;i<columns*rows;i++){
                    int counterOnes = 0;
                    if(i>=0 && i<columns) {
                        if(i<columns-1 && i!=0){
                            ...
                            if(allNums[i+1] == 1)
                                counterOnes++;
                            if(allNums[i+1+columns] ==1)
                                counterOnes++;
                            if(allNums[i+columns] == 1)
                                counterOnes++;
                            if(allNums[i-1] == 1)
                                counterOnes++;
                            if(allNums[i-1+columns] == 1)
                            ...
                            if(counterOnes==3 && allNums[i]==0)
                                localNumsReply[i]=1;
                            else if(allNums[i] == 1 && (counterOnes == 2 || counterOnes == 3 ) )
                                localNumsReply[i]=1;
                            else
                                localNumsReply[i]=0;
                        }
                    ...
                    else if( i > rows*columns - columns -1 ){
                         if( i < rows*columns -1 && i%columns !=0 ) {
                            if(allNums[i+1] == 1)
                                counterOnes++;
                            if(allNums[i+1-columns] ==1)
                                counterOnes++;
                        ...
                        if(i%columns<columns-1 && i%columns !=0){
                            ...
                            if((counterOnes==3 || counterOnes == 6) && allNums[i]==0)
                                localNumsReply[i]=1;
                            else if(allNums[i] == 1 && (counterOnes == 2 || counterOnes == 3 ) )
                                localNumsReply[i]=1;
                            else
            ...
            memcpy(allNums,localNumsReply,rows*columns*sizeof(int));
